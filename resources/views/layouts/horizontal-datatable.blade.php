    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" id="notifications-dropdown-show">
                    <div class="p-3">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="avatar-dropdown" onclick="avatar(this)">
                ...
                <div class="dropdown-menu dropdown-menu-end" id="avatar-dropdown-show">
                    <!-- item-->
